...
rem #---------------------------------------------------------------------------------#
rem # Name         = Windows Privilege Escalation Script                              #
rem # Reference    = http://www.fuzzysecurity.com/tutorials/16.html                   #
rem # Author       = cmd-n-control                                                    #
rem # Date         = 12/01/2018                                                       #
rem # Tested On    =                                                                  #
rem #                ***********************************                              #
rem #                *  Operating System  |  Version   *                              #
rem #                *---------------------------------*                              #
rem #                *  Windows XP - SP3  |    Pro     *                              #
rem #                *  Windows 7  - SP3  |    Pro     *                              #
rem #                *  Windows 10        |    Pro     *                              #
rem #                ***********************************                              #
rem # Usage        = WinPrivEsc.bat                                                   #
...
rem #--------------------------------------------------------------------------------#
rem #                         Local Privilege Escalation Exploits                    #
rem #--------------------------------------------------------------------------------#

@echo off

rem #----------------------------------------------------------------------------------------------------------------------------------#
rem #                  | Windows OS Matrix Grid - Check Results below for false positives  |                                           #
rem #----------------------------------------------------------------------------------------------------------------------------------#
